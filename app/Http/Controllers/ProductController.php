...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(),[
            'name_product' => 'required|max:30|unique:products',
            'unitary_value' => 'required|numeric|gt:0|max:9999999|regex:/^\d+(\.\d{1,2})?$/',
    ...
    public function update(Request $request, $product_id)
    {
        ...
        $validator = Validator::make($request->all(),[
            'name_product' => 'max:30',
            'unitary_value' => 'numeric|gt:0|max:9999999|regex:/^\d+(\.\d{1,2})?$/',
